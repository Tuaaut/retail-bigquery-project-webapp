...
A showcase project that turns a dbt + BigQuery analytics workflow into a usable web application. Users can upload a retail-style CSV file, trigger processing from the UI, and see both pipeline health and business-facing KPIs in the browser.
