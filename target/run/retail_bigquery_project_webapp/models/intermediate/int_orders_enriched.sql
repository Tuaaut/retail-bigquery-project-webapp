  ...
  create or replace view `retail-bigquery-project-webapp`.`analytics_webapp_dev`.`int_orders_enriched`
  OPTIONS()
  as 
...
select
  ...
  o.order_amount,
  o.order_status
from `retail-bigquery-project-webapp`.`analytics_webapp_dev`.`stg_orders` o
